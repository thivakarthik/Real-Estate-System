...
public class AddRent extends Frame{
	...
	AddRent(String id)
	{
       ...
       add(l1);
        ...
        l8=new JLabel("PRICE AMOUNT OF THE LAND YOU RENT");
//        l9=new JLabel("MINIMUM PRICE");
        l10=new JLabel("OWNER's NAME");
        l11=new JLabel("ADDRESS OF THE LAND YOU RENT");
...
//               }
               ...
               try{
                   if(z==0)
                   {
                   	...
                   	String query="insert into rentdetails(id,ltype,btype,atype,acent,city,lmark,price,sname,saddress,contact) values('"+id+"','"+ltype+"','"+btype+"','"+atype+"','"+acent+"','"+city+"','"+lmark+"','"+price+"','"+sname+"','"+saddress+"','"+contact+"')";
